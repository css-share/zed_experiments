...
HD_PWD='c:/xilinx/vivado/projects/pl2ps_interrupt_example/pl2ps_interrupt_example.tmp/axi4_pl_spi_ip_v1_0_project/axi4_pl_SPI_ip_v1_0_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_ip_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SPI_ip_v1_0.tcl -notrace
