...
HD_PWD='c:/xilinx/vivado/projects/pl2ps_interrupt_example/pl2ps_interrupt_example.tmp/axi4_pl_spi_ip_v1_0_project/axi4_pl_SPI_ip_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_ip_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPI_ip_v1_0.tcl
