...
-- Date        : Tue Jan 22 16:58:26 2019
-- Host        : AsusP8 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_1_SPI_ip_0_1_sim_netlist.vhdl
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SPI_fsm is
  port (
    ...
    \r_reg_reg[3]_P_0\ : in STD_LOGIC_VECTOR ( 0 to 0 );
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SPI_fsm;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SPI_fsm is
  ...
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[0]\ : label is "S2:010,S3:011,S1:001,S4:101,S0:000,S5:100";
  attribute KEEP : string;
  attribute KEEP of \FSM_sequential_state_reg[0]\ : label is "yes";
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[1]\ : label is "S2:010,S3:011,S1:001,S4:101,S0:000,S5:100";
  attribute KEEP of \FSM_sequential_state_reg[1]\ : label is "yes";
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[2]\ : label is "S2:010,S3:011,S1:001,S4:101,S0:000,S5:100";
  attribute KEEP of \FSM_sequential_state_reg[2]\ : label is "yes";
begin
  FSM_DONE <= \^fsm_done\;
FSM_DONE_INST_0: unisim.vcomponents.LUT3
    generic map(
      INIT => X"02"
    )
        port map (
...
\FSM_sequential_state[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"54AA54AA55555500"
    )
        port map (
      I0 => state(2),
      I1 => \r_reg_reg[3]_P_0\(0),
      I2 => \r_reg_reg[2]\,
      I3 => state(1),
      I4 => Q(24),
      I5 => state(0),
...
\r_reg[24]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"40"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_downCounter5Bits is
  port (
    \r_reg_reg[4]_P_0\ : out STD_LOGIC_VECTOR ( 0 to 0 );
    \FSM_sequential_state_reg[0]\ : out STD_LOGIC;
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_downCounter5Bits;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_downCounter5Bits is
  ...
  signal \^r_reg_reg[4]_p_0\ : STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute SOFT_HLUTNM of \r_reg[2]_i_3\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \r_reg[3]_C_i_1\ : label is "soft_lutpair0";
...
begin
  \r_reg_reg[4]_P_0\(0) <= \^r_reg_reg[4]_p_0\(0);
...
\r_reg[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F0F0F00E"
        ...
        port map (
      I0 => count(4),
      I1 => \^r_reg_reg[4]_p_0\(0),
      I2 => count(2),
      I3 => count(0),
      I4 => count(1),
      O => \r_reg[2]_i_1_n_0\
    );
\r_reg[2]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_leftShiftRegister25bits is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_leftShiftRegister25bits;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_leftShiftRegister25bits is
...
\r_reg_reg[0]_C\: unisim.vcomponents.FDCE
     port map (
      C => shift,
      CE => '1',
      CLR => \FSM_sequential_state_reg[0]_46\,
      D => SPI_MISO,
...
\r_reg_reg[0]_LDC\: unisim.vcomponents.LDCE
    generic map(
      ...
      CLR => \FSM_sequential_state_reg[0]_46\,
      D => '1',
      G => \FSM_sequential_state_reg[0]_45\,
      GE => '1',
...
\r_reg_reg[0]_P\: unisim.vcomponents.FDPE
     port map (
      ...
      CE => '1',
      D => SPI_MISO,
      PRE => \FSM_sequential_state_reg[0]_45\,
...
\r_reg_reg[10]_C\: unisim.vcomponents.FDCE
     port map (
      C => shift,
      CE => '1',
      CLR => \FSM_sequential_state_reg[0]_26\,
      D => r_reg(9),
...
\r_reg_reg[10]_LDC\: unisim.vcomponents.LDCE
    generic map(
      ...
      CLR => \FSM_sequential_state_reg[0]_26\,
      D => '1',
      G => \FSM_sequential_state_reg[0]_25\,
      GE => '1',
...
\r_reg_reg[10]_P\: unisim.vcomponents.FDPE
     port map (
      ...
      CE => '1',
      D => r_reg(9),
      PRE => \FSM_sequential_state_reg[0]_25\,
...
\r_reg_reg[11]_C\: unisim.vcomponents.FDCE
     port map (
      C => shift,
      CE => '1',
      CLR => \FSM_sequential_state_reg[0]_24\,
      D => r_reg(10),
...
\r_reg_reg[11]_LDC\: unisim.vcomponents.LDCE
    generic map(
      ...
      CLR => \FSM_sequential_state_reg[0]_24\,
      D => '1',
      G => \FSM_sequential_state_reg[0]_23\,
      GE => '1',
...
\r_reg_reg[11]_P\: unisim.vcomponents.FDPE
     port map (
      ...
      CE => '1',
      D => r_reg(10),
      PRE => \FSM_sequential_state_reg[0]_23\,
...
\r_reg_reg[12]_C\: unisim.vcomponents.FDCE
     port map (
      C => shift,
      CE => '1',
      CLR => \FSM_sequential_state_reg[0]_22\,
      D => r_reg(11),
...
\r_reg_reg[12]_LDC\: unisim.vcomponents.LDCE
    generic map(
      ...
      CLR => \FSM_sequential_state_reg[0]_22\,
      D => '1',
      G => \FSM_sequential_state_reg[0]_21\,
      GE => '1',
...
\r_reg_reg[12]_P\: unisim.vcomponents.FDPE
     port map (
      ...
      CE => '1',
      D => r_reg(11),
      PRE => \FSM_sequential_state_reg[0]_21\,
...
\r_reg_reg[13]_C\: unisim.vcomponents.FDCE
     port map (
      C => shift,
      CE => '1',
      CLR => \FSM_sequential_state_reg[0]_20\,
      D => r_reg(12),
...
\r_reg_reg[13]_LDC\: unisim.vcomponents.LDCE
    generic map(
      ...
      CLR => \FSM_sequential_state_reg[0]_20\,
      D => '1',
      G => \FSM_sequential_state_reg[0]_19\,
      GE => '1',
...
\r_reg_reg[13]_P\: unisim.vcomponents.FDPE
     port map (
      ...
      CE => '1',
      D => r_reg(12),
      PRE => \FSM_sequential_state_reg[0]_19\,
...
\r_reg_reg[14]_C\: unisim.vcomponents.FDCE
     port map (
      C => shift,
      CE => '1',
      CLR => \FSM_sequential_state_reg[0]_18\,
      D => r_reg(13),
...
\r_reg_reg[14]_LDC\: unisim.vcomponents.LDCE
    generic map(
      ...
      CLR => \FSM_sequential_state_reg[0]_18\,
      D => '1',
      G => \FSM_sequential_state_reg[0]_17\,
      GE => '1',
...
\r_reg_reg[14]_P\: unisim.vcomponents.FDPE
     port map (
      ...
      CE => '1',
      D => r_reg(13),
      PRE => \FSM_sequential_state_reg[0]_17\,
...
\r_reg_reg[15]_C\: unisim.vcomponents.FDCE
     port map (
      C => shift,
      CE => '1',
      CLR => \FSM_sequential_state_reg[0]_16\,
      D => r_reg(14),
...
\r_reg_reg[15]_LDC\: unisim.vcomponents.LDCE
    generic map(
      ...
      CLR => \FSM_sequential_state_reg[0]_16\,
      D => '1',
      G => \FSM_sequential_state_reg[0]_15\,
      GE => '1',
...
\r_reg_reg[15]_P\: unisim.vcomponents.FDPE
     port map (
      ...
      CE => '1',
      D => r_reg(14),
      PRE => \FSM_sequential_state_reg[0]_15\,
...
\r_reg_reg[16]_C\: unisim.vcomponents.FDCE
     port map (
      C => shift,
      CE => '1',
      CLR => \FSM_sequential_state_reg[0]_14\,
      D => r_reg(15),
...
\r_reg_reg[16]_LDC\: unisim.vcomponents.LDCE
    generic map(
      ...
      CLR => \FSM_sequential_state_reg[0]_14\,
      D => '1',
      G => \FSM_sequential_state_reg[0]_13\,
      GE => '1',
...
\r_reg_reg[16]_P\: unisim.vcomponents.FDPE
     port map (
      ...
      CE => '1',
      D => r_reg(15),
      PRE => \FSM_sequential_state_reg[0]_13\,
...
\r_reg_reg[17]_C\: unisim.vcomponents.FDCE
     port map (
      C => shift,
      CE => '1',
      CLR => \FSM_sequential_state_reg[0]_12\,
      D => r_reg(16),
...
\r_reg_reg[17]_P\: unisim.vcomponents.FDPE
     port map (
      ...
      CE => '1',
      D => r_reg(16),
      PRE => \FSM_sequential_state_reg[0]_11\,
...
\r_reg_reg[18]_C\: unisim.vcomponents.FDCE
     port map (
      C => shift,
      CE => '1',
      CLR => \FSM_sequential_state_reg[0]_10\,
      D => r_reg(17),
...
\r_reg_reg[18]_LDC\: unisim.vcomponents.LDCE
    generic map(
      ...
      CLR => \FSM_sequential_state_reg[0]_10\,
      D => '1',
      G => \FSM_sequential_state_reg[0]_9\,
      GE => '1',
...
\r_reg_reg[18]_P\: unisim.vcomponents.FDPE
     port map (
      ...
      CE => '1',
      D => r_reg(17),
      PRE => \FSM_sequential_state_reg[0]_9\,
...
\r_reg_reg[19]_C\: unisim.vcomponents.FDCE
     port map (
      C => shift,
      CE => '1',
      CLR => \FSM_sequential_state_reg[0]_8\,
      D => r_reg(18),
...
\r_reg_reg[19]_LDC\: unisim.vcomponents.LDCE
    generic map(
      ...
      CLR => \FSM_sequential_state_reg[0]_8\,
      D => '1',
      G => \FSM_sequential_state_reg[0]_7\,
      GE => '1',
...
\r_reg_reg[19]_P\: unisim.vcomponents.FDPE
     port map (
      ...
      CE => '1',
      D => r_reg(18),
      PRE => \FSM_sequential_state_reg[0]_7\,
...
\r_reg_reg[1]_C\: unisim.vcomponents.FDCE
     port map (
      C => shift,
      CE => '1',
      CLR => \FSM_sequential_state_reg[0]_44\,
      D => r_reg(0),
...
\r_reg_reg[1]_LDC\: unisim.vcomponents.LDCE
    generic map(
      ...
      CLR => \FSM_sequential_state_reg[0]_44\,
      D => '1',
      G => \FSM_sequential_state_reg[0]_43\,
      GE => '1',
...
\r_reg_reg[1]_P\: unisim.vcomponents.FDPE
     port map (
      ...
      CE => '1',
      D => r_reg(0),
      PRE => \FSM_sequential_state_reg[0]_43\,
...
\r_reg_reg[20]_C\: unisim.vcomponents.FDCE
     port map (
      C => shift,
      CE => '1',
      CLR => \FSM_sequential_state_reg[0]_6\,
      D => r_reg(19),
...
\r_reg_reg[20]_LDC\: unisim.vcomponents.LDCE
    generic map(
      ...
      CLR => \FSM_sequential_state_reg[0]_6\,
      D => '1',
      G => \FSM_sequential_state_reg[0]_5\,
      GE => '1',
...
\r_reg_reg[20]_P\: unisim.vcomponents.FDPE
     port map (
      ...
      CE => '1',
      D => r_reg(19),
      PRE => \FSM_sequential_state_reg[0]_5\,
...
\r_reg_reg[21]_C\: unisim.vcomponents.FDCE
     port map (
      C => shift,
      CE => '1',
      CLR => \FSM_sequential_state_reg[0]_4\,
      D => r_reg(20),
...
\r_reg_reg[21]_LDC\: unisim.vcomponents.LDCE
    generic map(
      ...
      CLR => \FSM_sequential_state_reg[0]_4\,
      D => '1',
      G => \FSM_sequential_state_reg[0]_3\,
      GE => '1',
...
\r_reg_reg[21]_P\: unisim.vcomponents.FDPE
     port map (
      ...
      CE => '1',
      D => r_reg(20),
      PRE => \FSM_sequential_state_reg[0]_3\,
...
\r_reg_reg[22]_LDC\: unisim.vcomponents.LDCE
    generic map(
      ...
      CLR => \FSM_sequential_state_reg[0]_2\,
      D => '1',
      G => \FSM_sequential_state_reg[0]_1\,
      GE => '1',
...
\r_reg_reg[22]_P\: unisim.vcomponents.FDPE
     port map (
      ...
      CE => '1',
      D => r_reg(21),
      PRE => \FSM_sequential_state_reg[0]_1\,
...
\r_reg_reg[2]_C\: unisim.vcomponents.FDCE
     port map (
      C => shift,
      CE => '1',
      CLR => \FSM_sequential_state_reg[0]_42\,
      D => r_reg(1),
...
\r_reg_reg[2]_LDC\: unisim.vcomponents.LDCE
    generic map(
      ...
      CLR => \FSM_sequential_state_reg[0]_42\,
      D => '1',
      G => \FSM_sequential_state_reg[0]_41\,
      GE => '1',
...
\r_reg_reg[2]_P\: unisim.vcomponents.FDPE
     port map (
      ...
      CE => '1',
      D => r_reg(1),
      PRE => \FSM_sequential_state_reg[0]_41\,
...
\r_reg_reg[3]_C\: unisim.vcomponents.FDCE
     port map (
      C => shift,
      CE => '1',
      CLR => \FSM_sequential_state_reg[0]_40\,
      D => r_reg(2),
      Q => \r_reg_reg[3]_C_n_0\
    );
\r_reg_reg[3]_LDC\: unisim.vcomponents.LDCE
    generic map(
      ...
      CLR => \FSM_sequential_state_reg[0]_40\,
      D => '1',
      G => \FSM_sequential_state_reg[0]_39\,
      GE => '1',
...
\r_reg_reg[3]_P\: unisim.vcomponents.FDPE
     port map (
      ...
      CE => '1',
      D => r_reg(2),
      PRE => \FSM_sequential_state_reg[0]_39\,
      Q => \r_reg_reg[3]_P_n_0\
    );
\r_reg_reg[4]_C\: unisim.vcomponents.FDCE
     port map (
      C => shift,
      CE => '1',
      CLR => \FSM_sequential_state_reg[0]_38\,
      D => r_reg(3),
      Q => \r_reg_reg[4]_C_n_0\
    );
\r_reg_reg[4]_LDC\: unisim.vcomponents.LDCE
    generic map(
      ...
      CLR => \FSM_sequential_state_reg[0]_38\,
      D => '1',
      G => \FSM_sequential_state_reg[0]_37\,
      GE => '1',
      Q => \r_reg_reg[4]_LDC_n_0\
    );
\r_reg_reg[4]_P\: unisim.vcomponents.FDPE
     port map (
      ...
      CE => '1',
      D => r_reg(3),
      PRE => \FSM_sequential_state_reg[0]_37\,
      Q => \r_reg_reg[4]_P_n_0\
    );
\r_reg_reg[5]_C\: unisim.vcomponents.FDCE
     port map (
      C => shift,
      CE => '1',
      CLR => \FSM_sequential_state_reg[0]_36\,
      D => r_reg(4),
...
\r_reg_reg[5]_LDC\: unisim.vcomponents.LDCE
    generic map(
      ...
      CLR => \FSM_sequential_state_reg[0]_36\,
      D => '1',
      G => \FSM_sequential_state_reg[0]_35\,
      GE => '1',
...
\r_reg_reg[5]_P\: unisim.vcomponents.FDPE
     port map (
      ...
      CE => '1',
      D => r_reg(4),
      PRE => \FSM_sequential_state_reg[0]_35\,
...
\r_reg_reg[6]_C\: unisim.vcomponents.FDCE
     port map (
      C => shift,
      CE => '1',
      CLR => \FSM_sequential_state_reg[0]_34\,
      D => r_reg(5),
...
\r_reg_reg[6]_LDC\: unisim.vcomponents.LDCE
    generic map(
      ...
      CLR => \FSM_sequential_state_reg[0]_34\,
      D => '1',
      G => \FSM_sequential_state_reg[0]_33\,
      GE => '1',
...
\r_reg_reg[6]_P\: unisim.vcomponents.FDPE
     port map (
      ...
      CE => '1',
      D => r_reg(5),
      PRE => \FSM_sequential_state_reg[0]_33\,
...
\r_reg_reg[7]_C\: unisim.vcomponents.FDCE
     port map (
      C => shift,
      CE => '1',
      CLR => \FSM_sequential_state_reg[0]_32\,
      D => r_reg(6),
...
\r_reg_reg[7]_LDC\: unisim.vcomponents.LDCE
    generic map(
      ...
      CLR => \FSM_sequential_state_reg[0]_32\,
      D => '1',
      G => \FSM_sequential_state_reg[0]_31\,
      GE => '1',
...
\r_reg_reg[7]_P\: unisim.vcomponents.FDPE
     port map (
      ...
      CE => '1',
      D => r_reg(6),
      PRE => \FSM_sequential_state_reg[0]_31\,
...
\r_reg_reg[8]_C\: unisim.vcomponents.FDCE
     port map (
      C => shift,
      CE => '1',
      CLR => \FSM_sequential_state_reg[0]_30\,
      D => r_reg(7),
...
\r_reg_reg[8]_LDC\: unisim.vcomponents.LDCE
    generic map(
      ...
      CLR => \FSM_sequential_state_reg[0]_30\,
      D => '1',
      G => \FSM_sequential_state_reg[0]_29\,
      GE => '1',
...
\r_reg_reg[8]_P\: unisim.vcomponents.FDPE
     port map (
      ...
      CE => '1',
      D => r_reg(7),
      PRE => \FSM_sequential_state_reg[0]_29\,
...
\r_reg_reg[9]_C\: unisim.vcomponents.FDCE
     port map (
      C => shift,
      CE => '1',
      CLR => \FSM_sequential_state_reg[0]_28\,
      D => r_reg(8),
...
\r_reg_reg[9]_LDC\: unisim.vcomponents.LDCE
    generic map(
      ...
      CLR => \FSM_sequential_state_reg[0]_28\,
      D => '1',
      G => \FSM_sequential_state_reg[0]_27\,
      GE => '1',
...
\r_reg_reg[9]_P\: unisim.vcomponents.FDPE
     port map (
      ...
      CE => '1',
      D => r_reg(8),
      PRE => \FSM_sequential_state_reg[0]_27\,
...
ff2: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_dff_1
     port map (
      Q_int_1 => Q_int_1,
      Q_int_2 => Q_int_2,
      s00_axi_aresetn => \^q_reg\
    );
ff3: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_dff_2
     port map (
      CLK => CLK,
      Q_int_0 => Q_int_0,
      Q_int_1 => Q_int_1,
...
ff4: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_dff_3
     port map (
      Q_int_3 => Q_int_3,
      Q_int_4 => Q_int_4,
      s00_axi_aresetn => \^q_reg\
    );
ff5: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_dff_4
     port map (
      Q_int_4 => Q_int_4,
      Q_int_5 => Q_int_5,
      s00_axi_aresetn => \^q_reg\
    );
ff6: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_dff_5
     port map (
      Q_int_5 => Q_int_5,
      Q_int_6 => Q_int_6,
      s00_axi_aresetn => \^q_reg\
    );
ff7: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_dff_6
     port map (
      \FSM_sequential_state_reg[0]\ => ff7_n_0,
      Q_int_4 => Q_int_4,
      Q_int_5 => Q_int_5,
      Q_int_6 => Q_int_6,
      s00_axi_aresetn => \^q_reg\,
...
begin
  SPI_SCK <= \^spi_sck\;
  SR(0) <= \^sr\(0);
CLOCKDIV: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_clock_divider
     port map (
      CLK => clock_int,
      Q_reg => \^sr\(0),
      s00_axi_aclk => s00_axi_aclk,
...
DWCNTR: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_downCounter5Bits
     port map (
      \FSM_sequential_state_reg[0]\ => DWCNTR_n_1,
      \FSM_sequential_state_reg[1]\ => FSM_n_24,
      \FSM_sequential_state_reg[1]_0\ => FSM_n_25,
      \FSM_sequential_state_reg[2]\ => \^spi_sck\,
      \r_reg_reg[4]_P_0\(0) => count(3),
      s00_axi_aresetn => \^sr\(0)
    );
FSM: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SPI_fsm
     port map (
      CLK => clock_int,
      D(0) => D(24),
      FSM_DONE => FSM_DONE,
      ...
      \r_reg_reg[0]_C\ => FSM_n_26,
      \r_reg_reg[0]_P\ => FSM_n_23,
      \r_reg_reg[10]_C\ => FSM_n_36,
      \r_reg_reg[10]_P\ => FSM_n_13,
      \r_reg_reg[11]_C\ => FSM_n_37,
      \r_reg_reg[11]_P\ => FSM_n_12,
      \r_reg_reg[12]_C\ => FSM_n_38,
      \r_reg_reg[12]_P\ => FSM_n_11,
      \r_reg_reg[13]_C\ => FSM_n_39,
      \r_reg_reg[13]_P\ => FSM_n_10,
      \r_reg_reg[14]_C\ => FSM_n_40,
      \r_reg_reg[14]_P\ => FSM_n_9,
      \r_reg_reg[15]_C\ => FSM_n_41,
      \r_reg_reg[15]_P\ => FSM_n_8,
      \r_reg_reg[16]_C\ => FSM_n_42,
      \r_reg_reg[16]_P\ => FSM_n_7,
      \r_reg_reg[17]_C\ => FSM_n_43,
      \r_reg_reg[17]_P\ => FSM_n_6,
      \r_reg_reg[18]_C\ => FSM_n_44,
      \r_reg_reg[18]_P\ => FSM_n_5,
      \r_reg_reg[19]_C\ => FSM_n_45,
      \r_reg_reg[19]_P\ => FSM_n_4,
      \r_reg_reg[1]_C\ => FSM_n_27,
      \r_reg_reg[1]_P\ => FSM_n_22,
      \r_reg_reg[20]_C\ => FSM_n_46,
      \r_reg_reg[20]_P\ => FSM_n_3,
      \r_reg_reg[21]_C\ => FSM_n_47,
      \r_reg_reg[21]_P\ => FSM_n_2,
      \r_reg_reg[22]_C\ => FSM_n_48,
      \r_reg_reg[22]_P\ => FSM_n_1,
      \r_reg_reg[23]_C\ => FSM_n_49,
      \r_reg_reg[23]_P\ => FSM_n_0,
      \r_reg_reg[24]\ => FSM_n_25,
      \r_reg_reg[2]\ => DWCNTR_n_1,
      \r_reg_reg[2]_C\ => FSM_n_28,
      \r_reg_reg[2]_P\ => FSM_n_21,
      \r_reg_reg[3]_C\ => FSM_n_29,
      \r_reg_reg[3]_P\ => FSM_n_20,
      \r_reg_reg[3]_P_0\(0) => count(3),
      \r_reg_reg[4]_C\ => FSM_n_30,
      \r_reg_reg[4]_P\ => FSM_n_19,
      \r_reg_reg[4]_P_0\ => FSM_n_24,
      \r_reg_reg[5]_C\ => FSM_n_31,
      \r_reg_reg[5]_P\ => FSM_n_18,
      \r_reg_reg[6]_C\ => FSM_n_32,
      \r_reg_reg[6]_P\ => FSM_n_17,
      \r_reg_reg[7]_C\ => FSM_n_33,
      \r_reg_reg[7]_P\ => FSM_n_16,
      \r_reg_reg[8]_C\ => FSM_n_34,
      \r_reg_reg[8]_P\ => FSM_n_15,
      \r_reg_reg[9]_C\ => FSM_n_35,
      \r_reg_reg[9]_P\ => FSM_n_14,
      s00_axi_aresetn => s00_axi_aresetn,
...
SR25Bits: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_leftShiftRegister25bits
     port map (
      D(23 downto 0) => D(23 downto 0),
      \FSM_sequential_state_reg[0]\ => FSM_n_0,
      \FSM_sequential_state_reg[0]_0\ => FSM_n_49,
      \FSM_sequential_state_reg[0]_1\ => FSM_n_1,
      \FSM_sequential_state_reg[0]_10\ => FSM_n_44,
      \FSM_sequential_state_reg[0]_11\ => FSM_n_6,
      \FSM_sequential_state_reg[0]_12\ => FSM_n_43,
      \FSM_sequential_state_reg[0]_13\ => FSM_n_7,
      \FSM_sequential_state_reg[0]_14\ => FSM_n_42,
      \FSM_sequential_state_reg[0]_15\ => FSM_n_8,
      \FSM_sequential_state_reg[0]_16\ => FSM_n_41,
      \FSM_sequential_state_reg[0]_17\ => FSM_n_9,
      \FSM_sequential_state_reg[0]_18\ => FSM_n_40,
      \FSM_sequential_state_reg[0]_19\ => FSM_n_10,
      \FSM_sequential_state_reg[0]_2\ => FSM_n_48,
      \FSM_sequential_state_reg[0]_20\ => FSM_n_39,
      \FSM_sequential_state_reg[0]_21\ => FSM_n_11,
      \FSM_sequential_state_reg[0]_22\ => FSM_n_38,
      \FSM_sequential_state_reg[0]_23\ => FSM_n_12,
      \FSM_sequential_state_reg[0]_24\ => FSM_n_37,
      \FSM_sequential_state_reg[0]_25\ => FSM_n_13,
      \FSM_sequential_state_reg[0]_26\ => FSM_n_36,
      \FSM_sequential_state_reg[0]_27\ => FSM_n_14,
      \FSM_sequential_state_reg[0]_28\ => FSM_n_35,
      \FSM_sequential_state_reg[0]_29\ => FSM_n_15,
      \FSM_sequential_state_reg[0]_3\ => FSM_n_2,
      \FSM_sequential_state_reg[0]_30\ => FSM_n_34,
      \FSM_sequential_state_reg[0]_31\ => FSM_n_16,
      \FSM_sequential_state_reg[0]_32\ => FSM_n_33,
      \FSM_sequential_state_reg[0]_33\ => FSM_n_17,
      \FSM_sequential_state_reg[0]_34\ => FSM_n_32,
      \FSM_sequential_state_reg[0]_35\ => FSM_n_18,
      \FSM_sequential_state_reg[0]_36\ => FSM_n_31,
      \FSM_sequential_state_reg[0]_37\ => FSM_n_19,
      \FSM_sequential_state_reg[0]_38\ => FSM_n_30,
      \FSM_sequential_state_reg[0]_39\ => FSM_n_20,
      \FSM_sequential_state_reg[0]_4\ => FSM_n_47,
      \FSM_sequential_state_reg[0]_40\ => FSM_n_29,
      \FSM_sequential_state_reg[0]_41\ => FSM_n_21,
      \FSM_sequential_state_reg[0]_42\ => FSM_n_28,
      \FSM_sequential_state_reg[0]_43\ => FSM_n_22,
      \FSM_sequential_state_reg[0]_44\ => FSM_n_27,
      \FSM_sequential_state_reg[0]_45\ => FSM_n_23,
      \FSM_sequential_state_reg[0]_46\ => FSM_n_26,
      \FSM_sequential_state_reg[0]_5\ => FSM_n_3,
      \FSM_sequential_state_reg[0]_6\ => FSM_n_46,
      \FSM_sequential_state_reg[0]_7\ => FSM_n_4,
      \FSM_sequential_state_reg[0]_8\ => FSM_n_45,
      \FSM_sequential_state_reg[0]_9\ => FSM_n_5,
      \FSM_sequential_state_reg[1]\ => FSM_n_25,
      MOSI_int => MOSI_int,
...
user_SPI_Block: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SPI_Master
     port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "design_1_SPI_ip_0_1,SPI_ip_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "SPI_ip_v1_0,Vivado 2018.2";
