...
HD_PWD='C:/Xilinx/Vivado/projects/pl2ps_interrupt_example/pl2ps_interrupt_example.runs/design_1_axi4_pl_interrupt_ge_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi4_pl_interrupt_ge_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi4_pl_interrupt_ge_0_0.tcl
