...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set DBG0 [ create_bd_port -dir O -type data DBG0 ]
  set DBG1 [ create_bd_port -dir O -type data DBG1 ]
  set DBG2 [ create_bd_port -dir O -type data DBG2 ]
  set DBG3 [ create_bd_port -dir O -type data DBG3 ]
  set DBG4 [ create_bd_port -dir O -type data DBG4 ]
  set HSIA0 [ create_bd_port -dir I -type data HSIA0 ]
  set HSIA1 [ create_bd_port -dir I -type data HSIA1 ]
  ...
  set MCK [ create_bd_port -dir O -type data MCK ]
  ...
  set SPI_ip_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:axi4_pl_SPI_ip:1.0 SPI_ip_0 ]
  ...
  # Create instance: axi_gyro_hsi_0, and set properties
  set axi_gyro_hsi_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:axi_gyro_hsi:1.0 axi_gyro_hsi_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins SPI_ip_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins axi_gyro_hsi_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]

  # Create port connections
  connect_bd_net -net HSIA0_1 [get_bd_ports HSIA0] [get_bd_pins axi_gyro_hsi_0/HSIA0]
  connect_bd_net -net HSIA1_1 [get_bd_ports HSIA1] [get_bd_pins axi_gyro_hsi_0/HSIA1]
  ...
  connect_bd_net -net axi_gyro_hsi_0_DBG0 [get_bd_ports DBG0] [get_bd_pins axi_gyro_hsi_0/DBG0]
  connect_bd_net -net axi_gyro_hsi_0_DBG1 [get_bd_ports DBG1] [get_bd_pins axi_gyro_hsi_0/DBG1]
  connect_bd_net -net axi_gyro_hsi_0_DBG2 [get_bd_ports DBG2] [get_bd_pins axi_gyro_hsi_0/DBG2]
  connect_bd_net -net axi_gyro_hsi_0_DBG3 [get_bd_ports DBG3] [get_bd_pins axi_gyro_hsi_0/DBG3]
  connect_bd_net -net axi_gyro_hsi_0_DBG4 [get_bd_ports DBG4] [get_bd_pins axi_gyro_hsi_0/DBG4]
  connect_bd_net -net axi_gyro_hsi_0_MCK [get_bd_ports MCK] [get_bd_pins axi_gyro_hsi_0/MCK]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins SPI_ip_0/s00_axi_aclk] [get_bd_pins axi4_pl_interrupt_ge_0/s00_axi_aclk] [get_bd_pins axi_gyro_hsi_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins SPI_ip_0/s00_axi_aresetn] [get_bd_pins axi4_pl_interrupt_ge_0/s00_axi_aresetn] [get_bd_pins axi_gyro_hsi_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gyro_hsi_0/S00_AXI/S00_AXI_reg] SEG_axi_gyro_hsi_0_S00_AXI_reg
